...
public class AutoRedTwo extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.forwards(leftFrontMotor, leftRearMotor, rightFrontMotor, rightRearMotor, 0.6, 0.3, 2950);
        ...
        angles = imu.getAngularOrientation();
        robot.turn(imu, angles, 282, leftFrontMotor, leftRearMotor, rightFrontMotor, rightRearMotor, -0.5, 0.5, robot);
        ...
        x = leftFrontMotor.getCurrentPosition() + 180;
        robot.forwards(leftFrontMotor, leftRearMotor, rightFrontMotor, rightRearMotor, 0.7, 0.5, x);

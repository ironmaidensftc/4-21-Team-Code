...
public class AutoBlueTwo extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.odsRun(rods, leftFrontMotor, leftRearMotor, rightFrontMotor, rightRearMotor, 0.25, 0.25, 0.1);
        ...
        x = leftFrontMotor.getCurrentPosition() + 550;
        robot.forwards(leftFrontMotor, leftRearMotor, rightFrontMotor, rightRearMotor, 0.2, 0.2, x);
        ...
        angles = imu.getAngularOrientation();
        y = Math.abs(angles.firstAngle) + 76; //NOT THE RIGHT VALUE!!!!

        robot.turn(imu, angles, y, leftFrontMotor, leftRearMotor, rightFrontMotor, rightRearMotor, 0.5, -0.5, robot);
        ...
        //Drive forward
        robot.drive(leftFrontMotor, leftRearMotor, rightFrontMotor, rightRearMotor, 0.2, 0.1);
        ...
        robot.color(colorCcache, rLinservo, lLinservo, colorCreader, "blue");
